...
export class Game extends Scene
{
    ...
    createPhilosophers(map, layers) {
        const philosopherConfigs = [
            { id: "plato", name: "Sam Altman", spawnPointName: "Plato", defaultDirection: "right", roamRadius: 800 },
            { id: "aristotle", name: "François Chollet", spawnPointName: "Aristotle", defaultDirection: "right", roamRadius: 700 },
            { id: "socrates", name: "Andrej Karpathy", spawnPointName: "Socrates", defaultDirection: "front", roamRadius: 750 },
            { id: "descartes", name: "John Jumper", spawnPointName: "Descartes", defaultDirection: "front", roamRadius: 650 },
            { id: "leibniz", name: "Jared Kaplan", spawnPointName: "Leibniz", defaultDirection: "front", roamRadius: 720 },
            { id: "ada_lovelace", name: "Chelsea Finn", spawnPointName: "Ada Lovelace", defaultDirection: "front", roamRadius: 680 },
            { id: "turing", name: "Elon Musk", spawnPointName: "Turing", defaultDirection: "front", roamRadius: 770 },
            { id: "searle", name: "Satya Nadella", spawnPointName: "Searle", defaultDirection: "front", roamRadius: 730 },
            { id: "chomsky", name: "Andrew Ng", spawnPointName: "Chomsky", defaultDirection: "front", roamRadius: 690 },
            { id: "dennett", name: "Aravind Srinivas", spawnPointName: "Dennett", defaultDirection: "front", roamRadius: 710 },
            { 
                id: "miguel", 
                name: "Deep",
                spawnPointName: "Miguel", 
                defaultDirection: "front", 
                roamRadius: 300,
                defaultMessage: "Hi there! I'm Deep, a Master's student from WPI. I am here to newtork with the best minds in AI and I also love to build things from a systems first perspective. This world trule feels like a simulation, doesn't it? " 
            },
            { 
                id: "paul", 
                name: "Aaditya",
                ...
                defaultDirection: "front",
                roamRadius: 300,
                defaultMessage: "Hey, I'm Aaditya, a Master's student from Kelley, IU. I am here to meet cool people who are working in the intersection of AI, Business and Design Thinking. What are your views on the responsible and ethical use of AI? " 
            }
        ];
        ...
        philosopherConfigs.forEach(config => {
            const spawnPoint = map.findObject("Objects", (obj) => obj.name === config.spawnPointName);
